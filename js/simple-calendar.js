  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function addData(year, month) {
      ...
      //对每一个格子遍历
        ...
        //添加扶贫打卡的日期的选中样式，例如2018年5月5日打卡了
          /*$.ajax({
              url: "http://192.168.1.195:9999/poverty-web-1.0-SNAPSHOT/help/time",
              data: {"helpNumber": 5700000299767683,"data":201806},
              method: "post",
              dataType: "json",
          ...
          /*var newarr=[{"year":2018,"mon":5,"day":12},{"year":2018,"mon":5,"day":13},{"year":2018,"mon":5,"day":14},];
          for(let i=0;i<newarr.length;i++){
              if(newarr[i].year === writeyear && newarr[i].day=== writeday && newarr[i].mon === writemonth){
                  this.selectDay = daysElement[i];
                  daysElement[i].classList.add("sc-pointday");
              }
          }*/
         /* if(2018 === writeyear && 5 === writeday && 5 === writemonth){
              this.selectDay = daysElement[i];
              daysElement[i].classList.add("sc-pointday");
          }*/
        //添加today样式
